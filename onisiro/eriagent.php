...
<body>
    <div class="container">
        ...
        <main>
            ...
            <h2>Agent Payment History</h2><br>
            ...
            if (isset($_GET['oluwa']) && isset($_GET['eri'])) {
                ...
                if ($resulta) {
                    ...
                    $riderReward = $rowa['totalReward'] ?? 0; // Default to 0 if no result
            
                    // Query to fetch account details
                    $query2 = "SELECT accountNumber, bankName, accountName FROM oluwa WHERE fullname = '$oluwa'";
                    ...
                    if ($result2) {
                        ...
                        <div class="productDetails">
                            <div class="itemPD">
                                Agent: <b><?php echo htmlspecialchars($oluwa); ?></b>
                            </div>
                            <div class="itemPD">
            ...
            <table id="shipmentTable" style="padding-left:10%; width: 90%;">
                ...
                <tbody id="table-body">
                    ...
                    if (isset($_GET['oluwa'])) {
                        ...
                        // Get data
                        $sqlb = "SELECT product, amount, destination, customersName, deliveryFee, riderReward, profitReward, date, createdBy, editedBy, recalledBy, confirmedBy 
                        FROM gbigbe 
                        WHERE payID6=$payID";
