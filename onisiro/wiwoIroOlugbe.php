                   ...
                   WHERE fullname = '$captain'";
                    ...
                    if ($result2) {
                        ...
                        <div class="productDetails">
                            ...
                            <div class="payBTN">
                                <a
                                    href="save_paymentCap.php?oluwa=<?php echo urlencode($captain); ?>&owo=<?php echo urlencode($captainReward); ?>&accountNumber=<?php echo urlencode($accountNumber); ?>&bank=<?php echo urlencode($bank); ?>&accountName=<?php echo urlencode($accountName); ?>">Make
                                    Payment</a>
                            </div>
                        </div>
                        <?php
            ...
            <table id="shipmentTable" style="padding-left:5%; width: 90%;">
                ...
                <tbody id="table-body">
                    ...
                    if (isset($_GET['olugbe'])) {
                        ...
                        // Get data
                        $sqlb = "SELECT product, amount, destination, deliveryFee, riderReward, date FROM gbigbe WHERE captain = '$captain' AND status = 'completed' AND accCaptain = 'beni' AND captainPayStatus = 'rara'";
