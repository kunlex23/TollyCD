            ...
            <table id="shipmentTable" style="padding-left:10%; width: 90%;">
                ...
                <tbody id="table-body">
                    ...
                    if (isset($_GET['partner'])) {
                        ...
                        // Get data
                        $sqlb = "SELECT product, amount, destination, customersName, deliveryFee, date, createdBy, editedBy, recalledBy, confirmedBy FROM gbigbe WHERE partner = '$partner' AND payID=$payID";
